/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: b788c1129c3aac1e4fb98a298ba427fc)
...
declare namespace Cloudflare {
	...
	interface Env {
		...
		ETHCC_ASSETS: R2Bucket;
		LOADER: WorkerLoader;
		AI: Ai;
		APIFY_API_TOKEN: string;
		ChatAgent: DurableObjectNamespace<import("./src/server/entry").ChatAgent>;
		TWITTER_ANALYSIS_WORKFLOW: Workflow<Parameters<import("./src/server/entry").TwitterAnalysisWorkflow['run']>[0]['payload']>;
	}
}
