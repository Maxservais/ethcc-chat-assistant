/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 8450cb62f55c8913f3200ab1ec4dec6f)
// Runtime types generated with workerd@1.20260217.0 2026-01-28 nodejs_compat
declare namespace Cloudflare {
  ...
  interface Env {
    ...
    TWITTER_ANALYSIS_WORKFLOW: Workflow<
      Parameters<import("./src/server/entry").TwitterAnalysisWorkflow["run"]>[0]["payload"]
    >;
  }
}
...
declare namespace NodeJS {
  interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "APIFY_API_TOKEN">> {}
}
