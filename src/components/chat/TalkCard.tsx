...
const TRACK_COLORS: Record<string, string> = {
  ...
  "Core Protocol": "bg-blue-500/15 text-blue-700 dark:text-blue-400 border-blue-500/25",
  ...
  "Token Engineering": "bg-amber-500/15 text-amber-700 dark:text-amber-400 border-amber-500/25",
  "For Developers and Users": "bg-cyan-500/15 text-cyan-700 dark:text-cyan-400 border-cyan-500/25",
  ...
  "Real World Ethereum": "bg-teal-500/15 text-teal-700 dark:text-teal-400 border-teal-500/25",
  Entertainment: "bg-rose-500/15 text-rose-700 dark:text-rose-400 border-rose-500/25",
  Governance: "bg-sky-500/15 text-sky-700 dark:text-sky-400 border-sky-500/25",
};
